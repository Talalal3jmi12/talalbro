...
client.on('ready', () => {
   console.log(`----------------`);
      console.log(`Desert Bot- Script By : @9B_T`);
        console.log(`----------------`);
...
client.on("message", async message => {
    if(message.content.startsWith(prefix + "help")) {
        let help = new Discord.RichEmbed()
            ...
            معلومات عن السيرفر : T{prefix}server
            برودكاست للأونلاين فقط : T{prefix}bco
            يعرض لك عدد المتبندين من سيرفرك : T{prefix}banned
            رابط سيرفر الدعم الفني : https://discord.gg/WqW68jF 
            **`);
